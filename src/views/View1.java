...
public class View1 extends javax.swing.JFrame {
    ...
    int number = 0;
    Font fonte = new Font("SansSerif", Font.PLAIN, 28);
    
    public View1() {
        initComponents();
        
        jButton1.setFont(fonte);
        jTextField2.setFont(fonte);
        jTextField3.setFont(fonte);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Quantos números serão sorteados?");
        ...
        jLabel2.setText("Número Único Aleatório Sorteado");

        jLabel3.setText("Números Primos Sorteados");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        sorteio = modelo.sorteio(number);
        jLabel4.setText("");
        for (int n : modelo.getnSorteados()) {
            jLabel4.setText(jLabel4.getText() + n + " - ");
        }
        jTextField3.setText("");
        for (int n : sorteio) {
